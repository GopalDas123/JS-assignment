...
// Chapter 2 --Task 6
// var email="pgorav11@gmail.com";
// var a=("My Email is "+ email);
// alert(a);

// Chapter 2 --Task 7
// var book="A smarter way to learn JavaScript";
// alert("I'm trying to learn JavaScript from the book "+book);

// Chapter 2 --Task 8
// document.write("Yes i can write HTML content thorugh javascript")
...
// var quan="";
// name=prompt("Enter your name: ");
// title=prompt("What do you want to buy: ");
// quan=prompt("Enter quantity: ");
// // “John Doe ordered 5 T-shirt(s) on XYZ Clothing store”
// document.write([name]+" " +"ordered"+" "+ [quan]+" "+[title]+"(s)"+" on XYZ clothing store");
...
// b=Number(prompt("Enter 2nd number: "));
// var c=a-b;
// document.write("Substraction of "+a+" & "+b+" is "+c);
...
// b=Number(prompt("Enter 2nd number: "));
// var c=a*b;
// document.write("Multiplication of "+a+" & "+b+" is "+c);
...
// b=Number(prompt("Enter 2nd number: "));
// var c=a/b;
// document.write("Division of "+a+" & "+b+" is "+c);

// Chapter 5 --Task 4
// var a=600;
// var tickets=Number(prompt("How many tickets you want to buy?: "));
// var price=a*tickets;
// document.write("Total cost to buy " + tickets +"tickets to a movie is "+price);
...
// var b_year="";
// var age="";
// b_year=Number(prompt("Enter your birth year: "));
// age=c_year-b_year;
